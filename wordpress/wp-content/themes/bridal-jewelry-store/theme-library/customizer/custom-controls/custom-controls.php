...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	class Bridal_Jewelry_Store_Toggle_Switch_Custom_Control extends WP_Customize_Control {
...
if ( class_exists( 'WP_Customize_Section' ) ) {
	 ...
	 * Upsell section
	 */
	class Bridal_Jewelry_Store_Upsell_Section extends WP_Customize_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'bridal-jewelry-store-upsell';
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="bridal_jewelry_store_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand <?php echo $section_class; ?>">
